    ...
    <div style={{ borderLeft: "1px solid #f2f2f2", flexShrink: 0, width: '300px', paddingLeft: '14px', paddingTop: '20px', paddingRight: '14px', backgroundColor: '#fff', overflow: 'auto' }}>
      ...
      <div style={{ marginTop: '10px', fontSize: "14px" }}>
        ...
        }
        {
          tab == "2" ? <div>
            <p>预览的 URL 地址</p >
            <div style={{ height: "40px", border: "1px solid #f2f2f2", marginTop: '8px', fontSize: "14px", backgroundColor: "rgb(245, 247, 250)", color: "rgb(140, 140, 140)", padding: "8px 8px" }}>请去表格激活一个网址类型的单元格</div>
